...
np.savez('result/res_arr.npz', x=indices_i, y=indices_j, z=values_z)
...
np.savez_compressed('result/res_arr_compressed.npz', x=indices_i, y=indices_j, z=values_z)

size_after_compressed = sum(arr.nbytes for arr in np.load('result/res_arr_compressed.npz').values())
